...
COMMUNITY_SERVICE = {'Ramat Gan': {'elderly people': ["עמך- ביקורי בית לניצולי שואה",
                                   ...
                                   'Children': [], 'Animals': [], 'Earth': []},
                     'Tel Aviv': {'elderly people': ["מטב- התנדבות טלפונית",
                                                     "מטב- הפעלות וסדנאות לקשישים"], 'Children': [], 'Animals': [], 'Earth': []},
'Bat Yam': {'elderly people': [], 'Children': [], 'Animals': [], 'Earth': []},
'Ashdod': {'elderly people': [], 'Children': [], 'Animals': [], 'Earth': []},
'Haifa': {'elderly people': [], 'Children': [], 'Animals': [], 'Earth': []},
'Petah Tikva': {'elderly people': [], 'Children': [], 'Animals': [], 'Earth': []}}

print(COMMUNITY_SERVICE['Ramat Gan']['elderly people'][4])